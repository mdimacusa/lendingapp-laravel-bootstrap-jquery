...
class CompanyIncomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //     {
        //         $sum_penalties = DB::table('payment_')->where('reference',$data->reference)->sum('penalty_interest');
        //         $sum_income[$data->reference] = $data->interest + $sum_penalties;
        //     }
        }


        return view('pages.report.company-income',compact('query','filters'));
    }
