			...
			<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
				...
				<div class="d-flex align-items-center gap-2 gap-lg-3">
					<div class="m-0" data-select2-id="select2-data-134-dux9">
                        <a href="{{route('user-management.administrator.create')}}" class="btn btn-sm btn-flex fw-bold btn-success">Create Administrator</a>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
															<div class="menu-item px-3">
                                                                <a href="{{route('user-management.administrator.profile',['tab'=>"transaction",'id' => Crypt::encrypt($user->id)])}}" class="menu-link px-3">View Profile</a>
															</div>
														</div>
													</td>
												</tr>
