                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="btn-group w-100 mb-5">
                            <a href="{{route('user-management.client.profile',['tab'=>'summary','id'=>Crypt::encrypt($clients->id)])}}" class="btn blocker btn-sm {{($tab=="summary"?'btn-default':'btn-sm btn-light-success')}}">Summary</a>
                            <a href="{{route('user-management.client.profile',['tab'=>'transaction','id'=>Crypt::encrypt($clients->id)])}}" class="btn blocker btn-sm {{($tab=="transaction"?'btn-default':'btn-sm btn-light-success')}}">Transaction</a>
                        </div>
                    </div>
                </div>
			    <div class="row g-5 g-xl-10 mb-xl-10 justify-content-center">
                    <div class="col-md-12">
                        @include('pages.user-management.tab')
                        </div>
                    </div>
                </div>
			</div>
