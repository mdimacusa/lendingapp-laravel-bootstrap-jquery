		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Company Income</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
				...
				<div class="d-flex align-items-center gap-2 gap-lg-3">
					<div class="m-0" data-select2-id="select2-data-134-dux9">
                        ...
                        <a href="{{url('report/company-income/download').'?'.http_build_query($filters)}}" class="btn btn-sm btn-flex bg-body btn-color-gray-700 btn-active-color-success fw-bold">Download</a>
					</div>
				</div>
			</div>
...
@section('custom')
 	<script>
        $('a.company-income').addClass('active');
   </script>
@endsection
@endsection
