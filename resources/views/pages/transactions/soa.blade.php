			...
			<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
				...
				<div class="d-flex align-items-center gap-2 gap-lg-3">
					<div class="m-0" data-select2-id="select2-data-134-dux9">
						...
						<a href="{{url('transactions/deposit-fund/download').'?'.http_build_query($filters)}}" class="btn btn-sm btn-flex bg-body btn-color-gray-700 btn-active-color-success fw-bold">Download</a>
					</div>
            							...
            							<tbody class="text-gray-600 fw-semibold">
                                            ...
                                            <tr>
												<td>
													...
													<div class="fs-5">Client Unique ID : {{$data->unique_id}}<div>
												</td>
												<td>
													@if($data->status == "0")
												...
												<td>
                                                    ...
                                                    @if($data->status==2)
                                                    <div class="fs-7">Processed By : {{$data->name??'NO DATA'}}<div>
                                                    @endif
												</td>
                                                <td class="text-end">
                								    ...
                								    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
                											<a href="{{url('transactions/statement-of-account/'.$status.'/'.Crypt::encrypt($data->reference))}}" class="menu-link px-3">Payment</a>
                										</div>
                                                        <div class="menu-item px-3">
                											<a href="{{url('transactions/'.Crypt::encrypt($data->reference))}}" target="_blank" class="menu-link px-3">View Receipt</a>
                										</div>
														@elseif($data->status == "1")
														<div class="menu-item px-3">
                											<a href="{{url('transactions/statement-of-account/'.$status.'/'.Crypt::encrypt($data->reference))}}" class="menu-link px-3">Payment</a>
                                                        ...
                                                        <div class="menu-item px-3">
                											<a href="{{url('transactions/statement-of-account/'.$status.'/payment-history/'.Crypt::encrypt($data->reference))}}" class="menu-link px-3">Payment History</a>
                										</div>
                                                        <div class="menu-item px-3">
                											<a href="{{url('transactions/'.Crypt::encrypt($data->reference))}}" target="_blank"class="menu-link px-3">View Receipt</a>
                										</div>
