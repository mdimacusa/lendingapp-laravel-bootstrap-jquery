	...
	<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
		...
		<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
			<a href="" class="d-lg-none">
				<img alt="Logo" src="{{asset('assets/images/angels-mini-lending.png')}}" class="h-30px" />
			</a>
		</div>
		<!--end::Mobile logo-->
			...
			<div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-3 ms-lg-9" id="kt_header_notifications_menu">
                    <div class="d-flex align-items-center" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <div class="cursor-pointer symbol symbol symbol-circle symbol-35px symbol-md-40px">
                            ...
                            @if($borrow_notif_credit->count() != 0 || $fund_notift->count() != 0)
                            <span style="width:15px;height:15px;position:absolute;top:-5px;right:1px;font-size:8px;font-weight:bold;color:#ffffff;background:#F3416C;border-radius: 40%;text-align:center;padding-top:1px">{{$notification_count}}</span>
                            @else
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane show active fade" id="borrow_notifications" role="tabpanel">
                                <div class="scroll-y mh-325px my-5 px-8">
                                    <!--begin::Item-->
                                    @if($borrow_notif_credit->count() == 0)
                                    <div class="d-flex justify-content-center">
                                        <p>No Found Data</p>
                                    </div>
                                    @else
                                    @foreach($borrow_notif_credit as $notif)
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px me-4">
                                                <span class="symbol-label bg-light-{{($notif->type=="DEBIT")?"danger":"success"}}">
                                            ...
                                            <div class="mb-0 me-2">
                                                <a href="#" class="fs-8 text-gray-800 text-hover-primary fw-bold">{{$notif->message}}</a>
                                                @php
                                                    $currentTime = new DateTime();
                                                    $timestampDateTime = new DateTime($notif->created_at);
                                                    $interval = $currentTime->diff($timestampDateTime);
                                                    $timeAgo = '';
                                        ...
                                        <span class="badge badge-light fs-8" style="background: none;">
                                            <a href="{{ url('user-management/administrator/notification/seen/'.$notif->id)}}" id="seen">Mark as read</a>
                                        </span>
                                        <!--end::Label-->
                                    </div>
                                    @endforeach
                            ...
                            <div class="tab-pane fade" id="fund_notifications" role="tabpanel">
                                <div class="scroll-y mh-325px my-5 px-8">
                                    <!--begin::Item-->
                                    @if($fund_notift->count() == 0)
                                    <div class="d-flex justify-content-center">
                                        <p>No Found Data</p>
                                    </div>
                                    @else
                                    @foreach($fund_notift as $notif)
                                    <div class="d-flex flex-stack py-4">
                                        <!--begin::Section-->
				...
				<div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
					...
					<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
							<img alt="profile" src="{{asset('assets/profile/blank.png')}}" alt="user" />
					</div>
						...
						<div class="menu-item px-3">
							<div class="menu-content d-flex align-items-center px-3">
								...
								<div class="symbol symbol-50px me-5">
									<img alt="profile" src="{{asset('assets/profile/blank.png')}}" />
								</div>
								<!--end::Avatar-->
								<!--begin::Username-->
								<div class="d-flex flex-column">
									<div class="fw-bold d-flex align-items-center fs-5">{{auth()->user()->name}}
								    	{{-- <span class="badge badge-light-success fw-bold fs-8 px-1 py-1 ms-2">Pro</span> --}}
									</div>
									<a href="#" class="fw-semibold text-muted text-hover-primary fs-8">{{auth()->user()->email}}</a>
                                    <div class="fs-8">{{auth()->user()->role}}</div>
								</div>
								<!--end::Username-->
							</div>
						</div>
